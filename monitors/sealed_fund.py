...
- 双条件阈值（2026-07-12 深度调研后定稿）：
  - 折价率 > 5%（sealed_fund_discount_threshold）-- 安全垫够厚
  - 年化 > 4%（sealed_fund_annualized_threshold）-- 比债基高，隐含到期<2年
- 折价是实际收益+安全垫，年化是资金效率参考
- 年化>4% 自动隐含到期<2年（折价5%年化4%=1.25年；折价7%年化4%=1.75年）

调研依据：
- 张翼轸《封基是如何每年白送你6%收益的》：年化6%+是"白送"，4%是保守底线
- 零城逆影《场内折价封闭基金投资指南》：7-10%折价常态，不要买2年以上的
- 当前市场（2026）折价普遍5-7%，远低于2019年的7-10%常态
